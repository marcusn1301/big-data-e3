...
def main():
    ...
    try:
        ...
        # print('Task 10')
        # forbiddenTrackpoints = list(trackpointsCollection.aggregate([
        #     {
        #         '$set': {
        #             'lat': {'$round': ['$lat', 3]},
        #             'lon': {'$round': ['$lon', 3]}
        ...
        # forbiddenUsers = list(activityCollection.aggregate([
        #     {'$match': {'_id': {'$in': [tp['activity_id']
        #                                 for tp in forbiddenTrackpoints]}}},
